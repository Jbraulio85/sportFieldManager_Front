...
const columns = [
  ...
  },
  {
    title: "Fecha",
    render: (text, record) => {
      const date = new Date(record.startTime).toLocaleDateString("es-ES", {
        day: "numeric",
        month: "long",
      });
  ...
  },
  {
    ...
    render: (text, record) => {
      return new Date(record.startTime).toLocaleTimeString("es-ES", {
        hour: "2-digit",
        minute: "2-digit",
      });
    },
  ...
  },
  {
    title: "Hora de Fin",
    render: (text, record) => {
      return new Date(record.endTime).toLocaleTimeString("es-ES", {
        hour: "2-digit",
        minute: "2-digit",
      });
    },
